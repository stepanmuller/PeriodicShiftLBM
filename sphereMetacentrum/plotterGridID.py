...
# Explicitly disable LaTeX rendering to prevent dependency errors
...
# 3. Setup Figure (FIXED: 3 plots side-by-side) -> Wait, 4 plots side-by-side based on the code below
