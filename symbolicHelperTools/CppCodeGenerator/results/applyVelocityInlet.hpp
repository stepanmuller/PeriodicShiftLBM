// Applies moment based boundary condition
// Calculates unknown distributions from rho, ux, uy, uz
...
else if ( outerNormalX == 0 && outerNormalY == 1 && outerNormalZ == 1 )
{
	...
	f3 = + s0 - s4 - s5 + s14;
	f5 = + s0 - s4 - s6 + s13;
	f7 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s11 - 0.5f * s14;
	f10 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s11 - 0.5f * s14;
	f11 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s13;
	f13 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f14 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s10 - 0.5f * s13;
	f16 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s13;
	f18 = - s0 - 0.5f * s2 - 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 + 0.5f * s9 + 0.5f * s10 - 0.5f * s13 - 0.5f * s14;
	f19 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f20 = + 0.25f * s7 + 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f21 = - 0.25f * s7 + 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f22 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f23 = - 0.5f * s1 - 0.5f * s4 - 0.25f * s7 - 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f25 = + 0.5f * s1 - 0.5f * s4 + 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == 1 && outerNormalY == 0 && outerNormalZ == 1 )
{
	...
	f2 = + s0 - s5 - s6 + s13;
	f3 = + s0 - s4 - s5 + s14;
	f7 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s10 - 0.5f * s14;
	f8 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s13;
	f10 = - s0 - 0.5f * s1 - 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 + 0.5f * s10 + 0.5f * s11 - 0.5f * s13 - 0.5f * s14;
	f11 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f13 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f15 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f18 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f19 = - 0.5f * s2 - 0.5f * s5 - 0.25f * s7 - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f21 = - 0.25f * s7 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13;
	f22 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s14;
	f23 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s14;
	f24 = + 0.25f * s7 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13;
	f25 = + 0.5f * s2 - 0.5f * s5 + 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == 1 && outerNormalY == 1 && outerNormalZ == 0 )
{
	...
	f2 = + s0 - s5 - s6 + s13;
	f5 = + s0 - s4 - s6 + s14;
	f8 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s10 - 0.5f * s13;
	f10 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f11 = - s0 - 0.5f * s1 - 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s11 + 0.5f * s12 - 0.5f * s13 - 0.5f * s14;
	f14 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s9 - 0.5f * s14;
	f15 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f16 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s11 - 0.5f * s14;
	f18 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s9 - 0.5f * s14;
	f19 = - 0.25f * s7 - 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f20 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f21 = - 0.5f * s3 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f23 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f24 = + 0.25f * s7 + 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f25 = + 0.5f * s3 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == 0 && outerNormalY == -1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f4 = + s0 - s4 - s5 + s14;
	f6 = + s0 - s4 - s6 + s13;
	f8 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s11 - 0.5f * s14;
	f9 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s11 - 0.5f * s14;
	f12 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s13;
	f13 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f14 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f15 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s13;
	f17 = - s0 + 0.5f * s2 + 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 - 0.5f * s9 - 0.5f * s10 - 0.5f * s13 - 0.5f * s14;
	f19 = + 0.25f * s7 - 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f20 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f21 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f22 = - 0.25f * s7 - 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f24 = + 0.5f * s1 - 0.5f * s4 - 0.25f * s7 - 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f26 = - 0.5f * s1 - 0.5f * s4 + 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == -1 && outerNormalY == 0 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f1 = + s0 - s5 - s6 + s13;
	f4 = + s0 - s4 - s5 + s14;
	f7 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s11 - 0.5f * s13;
	f8 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s10 - 0.5f * s14;
	f9 = - s0 + 0.5f * s1 + 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 - 0.5f * s10 - 0.5f * s11 - 0.5f * s13 - 0.5f * s14;
	f12 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f14 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f16 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f17 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f20 = + 0.5f * s2 - 0.5f * s5 - 0.25f * s7 - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f21 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s14;
	f22 = - 0.25f * s7 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13;
	f23 = + 0.25f * s7 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13;
	f24 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s14;
	f26 = - 0.5f * s2 - 0.5f * s5 + 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == -1 && outerNormalY == -1 && outerNormalZ == 0 )
{
	// Multiply K fk
	...
	f1 = + s0 - s5 - s6 + s13;
	f6 = + s0 - s4 - s6 + s14;
	f7 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f9 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s10 - 0.5f * s13;
	f12 = - s0 + 0.5f * s1 + 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 - 0.5f * s11 - 0.5f * s12 - 0.5f * s13 - 0.5f * s14;
	f13 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s9 - 0.5f * s14;
	f15 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s11 - 0.5f * s14;
	f16 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f17 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s9 - 0.5f * s14;
	f19 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f20 = - 0.25f * s7 + 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f22 = + 0.5f * s3 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f23 = + 0.25f * s7 - 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f24 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f26 = - 0.5f * s3 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
}
else if ( outerNormalX == 0 && outerNormalY == 1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f9 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s11 - 0.5f * s14;
	f11 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s13;
	f14 = - s0 - 0.5f * s2 + 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 + 0.5f * s9 - 0.5f * s10 - 0.5f * s13 - 0.5f * s14;
	f16 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s13;
	f17 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f18 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f20 = - 0.5f * s1 - 0.5f * s4 + 0.25f * s7 - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f21 = + 0.5f * s1 - 0.5f * s4 - 0.25f * s7 + 0.25f * s8 - 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f23 = - 0.25f * s7 - 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f24 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f25 = + 0.25f * s7 - 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f26 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
}
else if ( outerNormalX == 1 && outerNormalY == 0 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f2 = + s0 - s5 - s6 + s13;
	f4 = + s0 - s4 - s5 + s14;
	f8 = - s0 - 0.5f * s1 + 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 + 0.5f * s10 - 0.5f * s11 - 0.5f * s13 - 0.5f * s14;
	f9 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s10 - 0.5f * s14;
	f10 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s11 - 0.5f * s13;
	f11 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f14 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f15 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f17 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f19 = - 0.25f * s7 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13;
	f20 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s14;
	f21 = + 0.5f * s2 - 0.5f * s5 - 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f24 = - 0.5f * s2 - 0.5f * s5 + 0.25f * s7 - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f25 = + 0.25f * s7 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13;
	f26 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s14;
}
else if ( outerNormalX == 1 && outerNormalY == -1 && outerNormalZ == 0 )
{
	// Multiply K fk
	...
	f10 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f11 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f12 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s11 - 0.5f * s14;
	f13 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s9 - 0.5f * s14;
	f15 = - s0 - 0.5f * s1 + 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s11 - 0.5f * s12 - 0.5f * s13 - 0.5f * s14;
	f17 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s9 - 0.5f * s14;
	f19 = + 0.5f * s3 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f21 = - 0.25f * s7 + 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f22 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f24 = - 0.5f * s3 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f25 = + 0.25f * s7 - 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f26 = + 0.25f * s8 + 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
}
else if ( outerNormalX == 0 && outerNormalY == -1 && outerNormalZ == 1 )
{
	...
	f10 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s11 - 0.5f * s14;
	f12 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s13;
	f13 = - s0 + 0.5f * s2 - 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 - 0.5f * s9 + 0.5f * s10 - 0.5f * s13 - 0.5f * s14;
	f15 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s13;
	f17 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s10 - 0.5f * s13;
	f18 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f19 = + 0.5f * s1 - 0.5f * s4 + 0.25f * s7 - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f22 = - 0.5f * s1 - 0.5f * s4 - 0.25f * s7 + 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f23 = - 0.25f * s8 - 0.25f * s9 + 0.25f * s11 + 0.25f * s14;
	f24 = - 0.25f * s7 + 0.25f * s10 - 0.25f * s12 + 0.25f * s13;
	f25 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f26 = + 0.25f * s7 + 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
}
else if ( outerNormalX == -1 && outerNormalY == 0 && outerNormalZ == 1 )
{
	// Multiply K fk
	...
	f1 = + s0 - s5 - s6 + s13;
	f3 = + s0 - s4 - s5 + s14;
	f7 = - s0 + 0.5f * s1 - 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 - 0.5f * s10 + 0.5f * s11 - 0.5f * s13 - 0.5f * s14;
	f9 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s13;
	f10 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s10 - 0.5f * s14;
	f12 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f13 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s9 - 0.5f * s14;
	f16 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s12 - 0.5f * s13;
	f18 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s9 - 0.5f * s14;
	f19 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s14;
	f20 = - 0.25f * s7 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13;
	f22 = - 0.5f * s2 - 0.5f * s5 - 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f23 = + 0.5f * s2 - 0.5f * s5 + 0.25f * s7 - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f25 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s14;
	f26 = + 0.25f * s7 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13;
}
else if ( outerNormalX == -1 && outerNormalY == 1 && outerNormalZ == 0 )
{
	// Multiply K fk
	...
	f7 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s10 - 0.5f * s13;
	f9 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s10 - 0.5f * s13;
	f11 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s11 - 0.5f * s14;
	f12 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s12 - 0.5f * s13;
	f14 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s9 - 0.5f * s14;
	f16 = - s0 + 0.5f * s1 - 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 - 0.5f * s11 + 0.5f * s12 - 0.5f * s13 - 0.5f * s14;
	f18 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s9 - 0.5f * s14;
	f20 = - 0.5f * s3 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f21 = - 0.25f * s8 + 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f22 = - 0.25f * s7 - 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
	f23 = + 0.5f * s3 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 + 0.25f * s14;
	f25 = + 0.25f * s8 - 0.25f * s9 - 0.25f * s11 + 0.25f * s14;
	f26 = + 0.25f * s7 + 0.25f * s10 + 0.25f * s12 + 0.25f * s13;
}
else if ( outerNormalX == 1 && outerNormalY == 1 && outerNormalZ == 1 )
{
	...
	f3 = + s0 - s4 - s5 + s18;
	f5 = + s0 - s4 - s6 + s17;
	f7 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s18;
	f8 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s13 - 0.5f * s16;
	f10 = - s0 - 0.5f * s1 - 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 + 0.5f * s12 + 0.5f * s13 - 0.5f * s16 - 0.5f * s18;
	f11 = - s0 - 0.5f * s1 - 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s14 + 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f13 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s10 - 0.5f * s18;
	f14 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s17;
	f15 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s15 - 0.5f * s16;
	f16 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s14 - 0.5f * s17;
	f18 = - s0 - 0.5f * s2 - 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 + 0.5f * s10 + 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f19 = - 0.5f * s2 - 0.5f * s5 - 0.25f * s7 - 0.25f * s9 + 0.25f * s10 - 0.25f * s12 - 0.25f * s13 + 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f20 = + 0.25f * s8 + 0.25f * s11 + 0.25f * s14 + 0.25f * s17;
	f21 = - 0.5f * s3 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 + 0.25f * s11 + 0.25f * s13 - 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f22 = + 0.25f * s9 + 0.25f * s10 + 0.25f * s12 + 0.25f * s18;
	f23 = - 0.5f * s1 - 0.5f * s4 - 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f24 = + 0.25f * s7 + 0.25f * s13 + 0.25f * s15 + 0.25f * s16;
	f25 = + s0 + 0.5f * s1 + 0.5f * s2 + 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 + 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 - 0.25f * s13 - 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
}
else if ( outerNormalX == -1 && outerNormalY == -1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f4 = + s0 - s4 - s5 + s18;
	f6 = + s0 - s4 - s6 + s17;
	f7 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s13 - 0.5f * s16;
	f8 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s18;
	f9 = - s0 + 0.5f * s1 + 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 - 0.5f * s12 - 0.5f * s13 - 0.5f * s16 - 0.5f * s18;
	f12 = - s0 + 0.5f * s1 + 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 - 0.5f * s14 - 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f13 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s11 - 0.5f * s17;
	f14 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s10 - 0.5f * s18;
	f15 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s14 - 0.5f * s17;
	f16 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s15 - 0.5f * s16;
	f17 = - s0 + 0.5f * s2 + 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 - 0.5f * s10 - 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f19 = + 0.25f * s8 - 0.25f * s11 - 0.25f * s14 + 0.25f * s17;
	f20 = + 0.5f * s2 - 0.5f * s5 - 0.25f * s7 - 0.25f * s9 - 0.25f * s10 + 0.25f * s12 + 0.25f * s13 - 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f21 = + 0.25f * s9 - 0.25f * s10 - 0.25f * s12 + 0.25f * s18;
	f22 = + 0.5f * s3 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 - 0.25f * s11 - 0.25f * s13 + 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f23 = + 0.25f * s7 - 0.25f * s13 - 0.25f * s15 + 0.25f * s16;
	f24 = + 0.5f * s1 - 0.5f * s4 - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s11 - 0.25f * s12 - 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f26 = + s0 - 0.5f * s1 - 0.5f * s2 - 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
}
else if ( outerNormalX == -1 && outerNormalY == 1 && outerNormalZ == 1 )
{
	// Multiply K fk
	...
	f3 = + s0 - s4 - s5 + s18;
	f5 = + s0 - s4 - s6 + s17;
	f7 = - s0 + 0.5f * s1 - 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 - 0.5f * s12 + 0.5f * s13 - 0.5f * s16 - 0.5f * s18;
	f9 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s13 - 0.5f * s16;
	f10 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s12 - 0.5f * s18;
	f11 = - 0.5f * s1 + 0.5f * s4 + 0.5f * s14 - 0.5f * s17;
	f12 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s15 - 0.5f * s16;
	f13 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s10 - 0.5f * s18;
	f14 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s17;
	f16 = - s0 + 0.5f * s1 - 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 - 0.5f * s14 + 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f18 = - s0 - 0.5f * s2 - 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 + 0.5f * s10 + 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f19 = - 0.25f * s9 + 0.25f * s10 - 0.25f * s12 + 0.25f * s18;
	f20 = - 0.5f * s3 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 + 0.25f * s11 + 0.25f * s13 + 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f21 = - 0.25f * s8 + 0.25f * s11 - 0.25f * s14 + 0.25f * s17;
	f22 = - 0.5f * s2 - 0.5f * s5 - 0.25f * s7 + 0.25f * s9 + 0.25f * s10 + 0.25f * s12 - 0.25f * s13 + 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f23 = + s0 - 0.5f * s1 + 0.5f * s2 + 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 - 0.25f * s9 - 0.25f * s10 - 0.25f * s11 + 0.25f * s12 - 0.25f * s13 + 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f25 = + 0.5f * s1 - 0.5f * s4 + 0.25f * s8 + 0.25f * s9 - 0.25f * s10 - 0.25f * s11 - 0.25f * s12 - 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f26 = + 0.25f * s7 + 0.25f * s13 + 0.25f * s15 + 0.25f * s16;
}
else if ( outerNormalX == 1 && outerNormalY == -1 && outerNormalZ == 1 )
{
	// Multiply K fk
	...
	f8 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s13 - 0.5f * s16;
	f10 = - s0 - 0.5f * s1 - 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 + 0.5f * s12 + 0.5f * s13 - 0.5f * s16 - 0.5f * s18;
	f11 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s15 - 0.5f * s16;
	f12 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s14 - 0.5f * s17;
	f13 = - s0 + 0.5f * s2 - 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 - 0.5f * s10 + 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f15 = - s0 - 0.5f * s1 + 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s14 - 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f17 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s17;
	f18 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s10 - 0.5f * s18;
	f19 = + s0 + 0.5f * s1 - 0.5f * s2 + 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 - 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 - 0.25f * s13 - 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f21 = - 0.25f * s7 + 0.25f * s13 - 0.25f * s15 + 0.25f * s16;
	f22 = - 0.5f * s1 - 0.5f * s4 - 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 + 0.25f * s12 + 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f23 = - 0.25f * s9 - 0.25f * s10 + 0.25f * s12 + 0.25f * s18;
	f24 = - 0.5f * s3 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 + 0.25f * s11 + 0.25f * s13 - 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f25 = + 0.5f * s2 - 0.5f * s5 + 0.25f * s7 + 0.25f * s9 - 0.25f * s10 - 0.25f * s12 - 0.25f * s13 - 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f26 = + 0.25f * s8 + 0.25f * s11 + 0.25f * s14 + 0.25f * s17;
}
else if ( outerNormalX == 1 && outerNormalY == 1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f4 = + s0 - s4 - s5 + s18;
	f5 = + s0 - s4 - s6 + s17;
	f8 = - s0 - 0.5f * s1 + 0.5f * s3 + 0.5f * s4 + s5 + 0.5f * s6 + 0.5f * s12 - 0.5f * s13 - 0.5f * s16 - 0.5f * s18;
	f9 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s12 - 0.5f * s18;
	f10 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s13 - 0.5f * s16;
	f11 = - s0 - 0.5f * s1 - 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s14 + 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f14 = - s0 - 0.5f * s2 + 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 + 0.5f * s10 - 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f15 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s15 - 0.5f * s16;
	f16 = + 0.5f * s1 + 0.5f * s4 - 0.5f * s14 - 0.5f * s17;
	f17 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s10 - 0.5f * s18;
	f18 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s11 - 0.5f * s17;
	f19 = - 0.25f * s7 - 0.25f * s13 + 0.25f * s15 + 0.25f * s16;
	f20 = - 0.5f * s1 - 0.5f * s4 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f21 = + s0 + 0.5f * s1 + 0.5f * s2 - 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 - 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f23 = - 0.25f * s8 - 0.25f * s11 + 0.25f * s14 + 0.25f * s17;
	f24 = - 0.5f * s2 - 0.5f * s5 + 0.25f * s7 - 0.25f * s9 + 0.25f * s10 - 0.25f * s12 + 0.25f * s13 + 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f25 = + 0.5f * s3 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 - 0.25f * s11 - 0.25f * s13 - 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f26 = + 0.25f * s9 + 0.25f * s10 + 0.25f * s12 + 0.25f * s18;
}
else if ( outerNormalX == 1 && outerNormalY == -1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f15 = - s0 - 0.5f * s1 + 0.5f * s2 + 0.5f * s4 + 0.5f * s5 + s6 + 0.5f * s14 - 0.5f * s15 - 0.5f * s16 - 0.5f * s17;
	f17 = - s0 + 0.5f * s2 + 0.5f * s3 + s4 + 0.5f * s5 + 0.5f * s6 - 0.5f * s10 - 0.5f * s11 - 0.5f * s17 - 0.5f * s18;
	f19 = + 0.5f * s3 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 - 0.25f * s11 - 0.25f * s13 - 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f20 = - 0.25f * s9 - 0.25f * s10 + 0.25f * s12 + 0.25f * s18;
	f21 = + 0.5f * s2 - 0.5f * s5 - 0.25f * s7 + 0.25f * s9 - 0.25f * s10 - 0.25f * s12 + 0.25f * s13 - 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f22 = - 0.25f * s8 - 0.25f * s11 + 0.25f * s14 + 0.25f * s17;
	f24 = + s0 + 0.5f * s1 - 0.5f * s2 - 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 - 0.25f * s9 + 0.25f * s10 + 0.25f * s11 - 0.25f * s12 + 0.25f * s13 - 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f25 = + 0.25f * s7 - 0.25f * s13 - 0.25f * s15 + 0.25f * s16;
	f26 = - 0.5f * s1 - 0.5f * s4 + 0.25f * s8 + 0.25f * s9 + 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
}
else if ( outerNormalX == -1 && outerNormalY == 1 && outerNormalZ == -1 )
{
	// Multiply K fk
	...
	f17 = + 0.5f * s2 + 0.5f * s5 - 0.5f * s10 - 0.5f * s18;
	f18 = - 0.5f * s3 + 0.5f * s6 + 0.5f * s11 - 0.5f * s17;
	f20 = + s0 - 0.5f * s1 + 0.5f * s2 - 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 - 0.25f * s7 + 0.25f * s8 - 0.25f * s9 - 0.25f * s10 + 0.25f * s11 + 0.25f * s12 + 0.25f * s13 + 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f21 = + 0.5f * s1 - 0.5f * s4 - 0.25f * s8 + 0.25f * s9 - 0.25f * s10 + 0.25f * s11 - 0.25f * s12 - 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f22 = - 0.25f * s7 - 0.25f * s13 + 0.25f * s15 + 0.25f * s16;
	f23 = + 0.5f * s3 - 0.5f * s6 + 0.25f * s7 - 0.25f * s8 - 0.25f * s11 - 0.25f * s13 + 0.25f * s14 - 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
	f24 = - 0.25f * s9 + 0.25f * s10 - 0.25f * s12 + 0.25f * s18;
	f25 = + 0.25f * s8 - 0.25f * s11 - 0.25f * s14 + 0.25f * s17;
	f26 = - 0.5f * s2 - 0.5f * s5 + 0.25f * s7 + 0.25f * s9 + 0.25f * s10 + 0.25f * s12 + 0.25f * s13 + 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
}
else if ( outerNormalX == -1 && outerNormalY == -1 && outerNormalZ == 1 )
{
	// Multiply K fk
	...
	f17 = + 0.5f * s3 + 0.5f * s6 - 0.5f * s11 - 0.5f * s17;
	f18 = - 0.5f * s2 + 0.5f * s5 + 0.5f * s10 - 0.5f * s18;
	f19 = + 0.5f * s1 - 0.5f * s4 + 0.25f * s8 - 0.25f * s9 + 0.25f * s10 - 0.25f * s11 - 0.25f * s12 - 0.25f * s14 + 0.25f * s17 + 0.25f * s18;
	f20 = - 0.25f * s7 + 0.25f * s13 - 0.25f * s15 + 0.25f * s16;
	f22 = + s0 - 0.5f * s1 - 0.5f * s2 + 0.5f * s3 - 0.5f * s4 - 0.5f * s5 - 0.5f * s6 - 0.25f * s7 - 0.25f * s8 + 0.25f * s9 + 0.25f * s10 - 0.25f * s11 + 0.25f * s12 - 0.25f * s13 + 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17 + 0.25f * s18;
	f23 = + 0.5f * s2 - 0.5f * s5 + 0.25f * s7 - 0.25f * s9 - 0.25f * s10 + 0.25f * s12 - 0.25f * s13 - 0.25f * s15 + 0.25f * s16 + 0.25f * s18;
	f24 = - 0.25f * s8 + 0.25f * s11 - 0.25f * s14 + 0.25f * s17;
	f25 = + 0.25f * s9 - 0.25f * s10 - 0.25f * s12 + 0.25f * s18;
	f26 = - 0.5f * s3 - 0.5f * s6 + 0.25f * s7 + 0.25f * s8 + 0.25f * s11 + 0.25f * s13 + 0.25f * s14 + 0.25f * s15 + 0.25f * s16 + 0.25f * s17;
}