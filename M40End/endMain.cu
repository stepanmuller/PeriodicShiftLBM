...
std::string STLPathBlade = "pumpEndSTL.STL";
...
int main(int argc, char **argv)
{
	...
	*/
	...
	grids[0].Info.cellCountX = (int)( (30.f) / grids[0].Info.res ) + 2;
	grids[0].Info.cellCountY = grids[0].Info.cellCountX;
	grids[0].Info.cellCountZ = (STLBlade.zmax - STLBlade.zmin) / grids[0].Info.res;
	grids[0].Info.ox = - (grids[0].Info.cellCountX / 2) * grids[0].Info.res;
	grids[0].Info.oy = grids[0].Info.ox;
	grids[0].Info.oz = STLBlade.zmin;
