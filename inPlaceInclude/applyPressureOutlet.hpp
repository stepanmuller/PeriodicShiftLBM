// Applies pressure outlet moment based boundary condition on a face cell
// 1. Reads known distributions and prescribed rho
// 2. Calculates normal u component from consistency condition
// 3. Uses moments to calculate tangential u components
// 4. Applies general moment based boundary condition to find unknown distributions
